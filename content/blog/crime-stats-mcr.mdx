...
## A front-end portfolio data visualisation project built with TypeScript and React

<FrameWrapper>
  <MacImageFrame src={macFrame} />
  <PhoneImageFrame src={phoneFrame} />
  <ul>
    <li>Project Type: Front-end</li>
    <li>Tech: TypeScript, React, Node.js, Styled Components</li>
    <li>
      Data: <a href="https://data.police.uk/">Police API</a>
    </li>
    <li>Testing: Jest</li>
  </ul>
</FrameWrapper>
